                        ...
                        <td class="td1">
                            ...
                            <div class="dob">
                                <div class="dobd">
                                    ...
                                    <input type="text" class="input_style1" name="dobd" value="<?php if ($dobd == 0) {
                                                                                                } else {
                                                                                                    echo $dobd;
                                                                                                } ?>" /><span> / </span>
                                </div>
                                ...
                                <div class="dobm">
                                    ...
                                    &nbsp <input type="text" class="input_style1" name="dobm" value="<?php if ($dobm == 0) {
                                                                                                        } else {
                                                                                                            echo $dobm;
                                                                                                        } ?>" /><span> / </span>
                                </div>
                                ...
                                <div class="doby">
                                    ...
                                    &nbsp <input type="text" class="input_style1" style="width:50px;" name="doby" value="<?php if ($doby == 0) {
                                                                                                                            } else {
                                                                                                                                echo $doby;
                                                                                                                            } ?>" />
                                </div>
                            ...
                            <div class="degree">
                                ...
                                <input type="checkbox" id="ssc" name="degree1" <?php if (isset($degree1) && $degree1 == "ssc") echo "checked"; ?> checked value="ssc">
                            ...
                            <div class="Blood Group:">
                                ...
                                <select name="blood_group" style="width:150px;">
                                    <option <?php if (isset($blood_group) && $blood_group == "") {
                                                echo ' selected="selected"';
                                            } ?> value="" disabled>Select one</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "a+") {
                                                echo ' selected="selected"';
                                            } ?> value="a+">A+</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "a-") {
                                                echo ' selected="selected"';
                                            } ?> value="a-">A-</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "b+") {
                                                echo ' selected="selected"';
                                            } ?> value="b+">B+</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "b-") {
                                                echo ' selected="selected"';
                                            } ?> value="b-">B-</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "0+") {
                                                echo ' selected="selected"';
                                            } ?> value="o+">O+</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "o-") {
                                                echo ' selected="selected"';
                                            } ?> value="o-">O-</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "ab+") {
                                                echo ' selected="selected"';
                                            } ?> value="ab+">AB+</option>
                                    <option <?php if (isset($blood_group) && $blood_group == "ab-") {
                                                echo ' selected="selected"';
