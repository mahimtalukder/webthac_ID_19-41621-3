<?php
 ...
 class addstudent{
    ...
    function addData($data)
    {
      ...
      if (empty($this-> error["nameErr"]) && empty($this-> error["emailErr"]) && empty($this-> error["passwordErr"]) && empty($this-> error["confirm_passwordErr"]) && empty($this-> error["dobErr"]) && empty($this-> error["genderErr"])) {
        require_once "C:/xampp/htdocs/Fall21_22/Lab task 6/model/model.php";
